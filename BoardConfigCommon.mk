...
TARGET_KERNEL_SOURCE := vendor/qcom/kernel
TARGET_KERNEL_VERSION := 6.12

# Kernel modules
BOARD_VENDOR_RAMDISK_KERNEL_MODULES_LOAD := \
    $(strip $(shell cat $(COMMON_PATH)/vendor_ramdisk.modules.load))

BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD := \
    $(strip $(shell cat $(COMMON_PATH)/vendor_ramdisk.modules.load.recovery))

BOARD_VENDOR_RAMDISK_KERNEL_MODULES_BLOCKLIST_FILE := \
    $(COMMON_PATH)/vendor_ramdisk.modules.blocklist
...
BOARD_VENDOR_KERNEL_MODULES_BLOCKLIST_FILE := \
    $(COMMON_PATH)/vendor_dlkm.modules.blocklist

BOARD_VENDOR_KERNEL_MODULES_LOAD := \
    $(strip $(shell cat $(COMMON_PATH)/vendor_dlkm.modules.load))
